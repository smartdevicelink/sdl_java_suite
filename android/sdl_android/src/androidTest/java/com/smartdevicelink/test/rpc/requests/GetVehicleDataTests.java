...
public class GetVehicleDataTests extends BaseRpcTests {
    ...
    protected JSONObject getExpectedParameters(int sdlVersion){
        ...
        try{
            ...
            result.put(GetVehicleData.KEY_STABILITY_CONTROL_STATUS, Test.GENERAL_BOOLEAN);
    ...
    public void testRpcValues () {    	
		...
		assertTrue(Test.TRUE, ( (GetVehicleData) msg ).getStabilityControlStatus());
    ...
    public void testJsonConstructor () {
		...
		try {
			...
			assertEquals(Test.MATCH, JsonUtils.readBooleanFromJsonObject(parameters, GetVehicleData.KEY_STABILITY_CONTROL_STATUS), cmd.getStabilityControlStatus());
