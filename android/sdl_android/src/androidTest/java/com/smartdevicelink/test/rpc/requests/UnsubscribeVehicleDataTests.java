...
public class UnsubscribeVehicleDataTests extends BaseRpcTests {
	...
	protected JSONObject getExpectedParameters(int sdlVersion) {
		...
		try {
			...
			result.put(UnsubscribeVehicleData.KEY_STABILITY_CONTROL_STATUS, Test.GENERAL_BOOLEAN);
	...
	public void testRpcValues(){		
		...
		assertTrue(Test.TRUE,( (UnsubscribeVehicleData) msg ).getStabilityControlStatus());
    ...
    public void testJsonConstructor () {
		...
		try {
			...
			assertEquals(Test.MATCH, JsonUtils.readBooleanFromJsonObject(parameters, UnsubscribeVehicleData.KEY_STABILITY_CONTROL_STATUS), cmd.getStabilityControlStatus());
