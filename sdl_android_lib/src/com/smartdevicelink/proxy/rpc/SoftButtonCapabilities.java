...
public class SoftButtonCapabilities extends RPCStruct {
    ...
    public void setShortPressAvailable(Boolean shortPressAvailable) {
        if (shortPressAvailable != null) {
            store.put(SoftButtonCapabilities.shortPressAvailable, shortPressAvailable);
        } else {
        	store.remove(SoftButtonCapabilities.shortPressAvailable);
        }
    }
    ...
    public Boolean getShortPressAvailable() {
        return (Boolean) store.get( SoftButtonCapabilities.shortPressAvailable);
    }
    ...
    public void setLongPressAvailable(Boolean longPressAvailable) {
        if (longPressAvailable != null) {
            store.put(SoftButtonCapabilities.longPressAvailable, longPressAvailable);
        } else {
        	store.remove(SoftButtonCapabilities.longPressAvailable);
        }
    }
    ...
    public Boolean getLongPressAvailable() {
        return (Boolean) store.get( SoftButtonCapabilities.longPressAvailable);
    }
    ...
    public void setUpDownAvailable(Boolean upDownAvailable) {
        if (upDownAvailable != null) {
            store.put(SoftButtonCapabilities.upDownAvailable, upDownAvailable);
        } else {
        	store.remove(SoftButtonCapabilities.upDownAvailable);
        }
    }
    ...
    public Boolean getUpDownAvailable() {
        return (Boolean) store.get( SoftButtonCapabilities.upDownAvailable);
    }
    ...
    public void setImageSupported(Boolean imageSupported) {
        if (imageSupported != null) {
            store.put(SoftButtonCapabilities.imageSupported, imageSupported);
        } else {
        	store.remove(SoftButtonCapabilities.imageSupported);
        }
    }
    ...
    public Boolean getImageSupported() {
        return (Boolean) store.get( SoftButtonCapabilities.imageSupported);
    }
}
