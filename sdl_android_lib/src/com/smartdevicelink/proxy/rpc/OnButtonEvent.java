...
public class OnButtonEvent extends RPCNotification {
	...
	*/
    ...
    public OnButtonEvent(JSONObject jsonObject) {
        super(SdlCommand.ON_BUTTON_EVENT, jsonObject);
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((buttonEventMode == null) ? 0 : buttonEventMode.hashCode());
	...
	public boolean equals(Object obj) {
		...
		OnButtonEvent other = (OnButtonEvent) obj;
		if (buttonEventMode == null) {
			if (other.buttonEventMode != null) { 
				return false;
			}
		} else if (!buttonEventMode.equals(other.buttonEventMode)) { 
			return false;
		}
		if (buttonName == null) {
