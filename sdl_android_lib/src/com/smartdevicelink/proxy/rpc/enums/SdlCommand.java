...
public enum SdlCommand implements JsonName{
     ...
     * @see Alert
     */
    ALERT ("Alert", "Alert", Alert.class, AlertResponse.class, null),
    /**
     ...
     * @see ButtonName
     */
    SUBSCRIBE_BUTTON ("Subscribe to Buttons", "SubscribeButton", SubscribeButton.class, SubscribeButtonResponse.class, null),
    /**
     ...
     * @see ButtonName
     */
    UNSUBSCRIBE_BUTTON ("Unsubscribe from Buttons", "UnsubscribeButton", UnsubscribeButton.class, UnsubscribeButtonResponse.class, null),
    /**
     ...
     * @see CommandButton
     */
    ADD_COMMAND ("Add a Command", "AddCommand", AddCommand.class, AddCommandResponse.class, null),
    /**
     * SDL DeleteCommand command deletes a command menu item that has been added by the application.
     * @see DeleteCommand
     * @see AddCommand
     */
    DELETE_COMMAND ("Delete a Command", "DeleteCommand", DeleteCommand.class, DeleteCommandResponse.class, null),
    /**
     ...
     * @see SubmenuButton
     */
    ADD_SUBMENU ("Add a Submenu", "AddSubMenu", AddSubMenu.class, AddSubMenuResponse.class, null),
    /**
     * SDL DeleteSubmenu command deletes a submenu menu item that has been added by the application.
     * @see DeleteSubmenu
     * @see AddSubmenu
     */
    DELETE_SUB_MENU ("Delete a Submenu", "DeleteSubMenu", DeleteSubMenu.class, DeleteSubMenuResponse.class, null),
    /**
     ...
     */
    SET_GLOBAL_PROPERTIES ("Set Global Properties", "SetGlobalProperties", SetGlobalProperties.class, SetGlobalPropertiesResponse.class, null),
    /**
     * SDL ResetGlobalProperties command resets global voice properties for your application to the vehicle's default settings.
     * @see ResetGlobalProperties
     * @see SetGlobalProperties
     */
    RESET_GLOBAL_PROPERTIES ("Reset Global Properties", "ResetGlobalProperties", ResetGlobalProperties.class, ResetGlobalPropertiesResponse.class, null),
    /**
     ...
     */
    SET_MEDIA_CLOCK_TIMER ("Set Media Clock Timer", "SetMediaClockTimer", SetMediaClockTimer.class, SetMediaClockTimerResponse.class, null),
    /**
     ...
     */
    CREATE_INTERACTION_CHOICE_SET ("Create Interaction Choice Set", "CreateInteractionChoiceSet", CreateInteractionChoiceSet.class, CreateInteractionChoiceSetResponse.class, null),
    /**
     ...
     * @see CreateInteractionChoiceSet
     */
    DELETE_INTERACTION_CHOICE_SET ("Delete Interaction Choice Set", "DeleteInteractionChoiceSet", DeleteInteractionChoiceSet.class, DeleteInteractionChoiceSetResponse.class, null),
    /**
     ...
     * @see CreateInteractionChoiceSet
     */
    PERFORM_INTERACTION ("Perform Interaction", "PerformInteraction", PerformInteraction.class, PerformInteractionResponse.class, null),
    /**
     ...
     * @see Slider
     */
    SLIDER ("Slider", "Slider", Slider.class, SliderResponse.class, null),
    /**
     ...
     */
    SCROLLABLE_MESSAGE ("Scrollable Message", "ScrollableMessage", ScrollableMessage.class, ScrollableMessageResponse.class, null),
    /**
     ...
     */
    CHANGE_REGISTRATION ("Change Registration", "ChangeRegistration", ChangeRegistration.class, ChangeRegistrationResponse.class, null),
    /**
     ...
     * @see SetAppIcon
     */
    PUT_FILE ("Put File", "PutFile", PutFile.class, PutFileResponse.class, null),
    /**
     ...
     * @see ListFiles
     */
    DELETE_FILE ("Delete File", "DeleteFile", DeleteFile.class, DeleteFileResponse.class, null),
    /**
     ...
     * @see DeleteFile
     */
    LIST_FILES ("List Files", "ListFiles", ListFiles.class, ListFilesResponse.class, null),
    /**
     ...
     * @see PutFile
     */
    SET_APP_ICON ("Set App Icon", "SetAppIcon", SetAppIcon.class, SetAppIconResponse.class, null),
    /**
     ...
     */
    PERFORM_AUDIO_PASSTHRU ("Perform Audio Pass-through", "PerformAudioPassThru", PerformAudioPassThru.class, PerformAudioPassThruResponse.class, null),
    /**
     * SDL EndAudioPassThru command ends a voice-input session previously started through the PerformAudioPassThru command.
     */
    END_AUDIO_PASSTHRU ("End Audio Pass-through", "EndAudioPassThru", EndAudioPassThru.class, EndAudioPassThruResponse.class, null),
    /**
     ...
     * @see GetVehicleData
     */
    SUBSCRIBE_VEHICLE_DATA ("Subscribe to Vehicle Data", "SubscribeVehicleData", SubscribeVehicleData.class, SubscribeVehicleDataResponse.class, null),
    /**
     ...
     * @see GetVehicleData
     */
    UNSUBSCRIBE_VEHICLE_DATA ("Unsubscribe from Vehicle Data", "UnsubscribeVehicleData", UnsubscribeVehicleData.class, UnsubscribeVehicleDataResponse.class, null),
    /**
     ...
     */
    GET_VEHICLE_DATA ("Get Vehicle Data", "GetVehicleData", GetVehicleData.class, GetVehicleDataResponse.class, null),
    /**
     ...
     * @see ReadDID
     */
    READ_DIDS ("Read DIDs", "ReadDID", ReadDID.class, ReadDIDResponse.class, null),
    /**
     ...
     * @see GetDTCs
     */
    GET_DTCS ("Get DTCs", "GetDTCs", GetDTCs.class, GetDTCsResponse.class, null),
    GENERIC_RESPONSE("Generic Response", "GenericResponse", null, GenericResponse.class, null),
    ON_APP_INTERFACE_UNREGISTERED("On App Interface Unregistered", "OnAppInterfaceUnregistered", null, null, OnAppInterfaceUnregistered.class),
    ON_AUDIO_PASS_THRU("On Audio PassThru", "OnAudioPassThru", null, null, OnAudioPassThru.class),
    ON_BUTTON_EVENT("On Button Event", "OnButtonEvent", null, null, OnButtonEvent.class),
    ON_BUTTON_PRESS("On Button Press", "OnButtonPress", null, null, OnButtonPress.class),
    ON_COMMAND("On Command", "OnCommand", null, null, OnCommand.class),
    ON_DRIVER_DISTRACTION("On Driver Distraction", "OnDriverDistraction", null, null, OnDriverDistraction.class),
    ON_HMI_STATUS("On HMI Status", "OnHMIStatus", null, null, OnHMIStatus.class),
    ON_LANGUAGE_CHANGE("On Language Change", "OnLanguageChange", null, null, OnLanguageChange.class),
    ON_PERMISSIONS_CHANGE("On Permissions Change", "OnPermissionsChange", null, null, OnPermissionsChange.class),
    ON_SDL_CHOICE_CHOSEN("On SDL Choice Chosen", "OnSmartDeviceLinkChoiceChosen", null, null, OnSdlChoiceChosen.class),
    ON_TBT_CLIENT_STATE("On TBT Client State", "OnTBTClientState", null, null, OnTBTClientState.class),
    ON_VEHICLE_DATA("On Vehicle Data", "OnVehicleData", null, null, OnVehicleData.class),
    REGISTER_APP_INTERFACE("Register App Interface", "RegisterAppInterface", RegisterAppInterface.class, RegisterAppInterfaceResponse.class, null),
    UNREGISTER_APP_INTERFACE("Unregister App Interface", "UnregisterAppInterface", UnregisterAppInterface.class, UnregisterAppInterfaceResponse.class, null),
    SET_DISPLAY_LAYOUT("Set Display Layout", "SetDisplayLayout", SetDisplayLayout.class, SetDisplayLayoutResponse.class, null),
    ...
    //constructor
    private SdlCommand(String readableName, String jsonName, Class<?> requestClass, Class<?> responseClass, Class<?> notificationClass){
    ...
    /**
     * Performs a reverse-lookup based on the friendly name of the object.
     * 
     * @param jsonName The name to look up
     * @return The SdlCommand if found, null otherwise
     */
    public static SdlCommand lookupByFriendlyName(String friendlyName) {
        for (SdlCommand anEnum : EnumSet.allOf(SdlCommand.class)) {
            if (anEnum.toString().equals(friendlyName)) {
                return anEnum;
            }
        }
        return null;
