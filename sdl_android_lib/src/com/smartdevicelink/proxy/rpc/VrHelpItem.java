...
/**
 * 
 * VR help items Ð i.e. the text strings to be displayed, and when pronounced by the user the recognision of any of which must trigger the corresponding VR command.
 *<p>
