...
public class UnsubscribeVehicleData extends RPCRequest {
    ...
    /**
     * Creates a UnsubscribeVehicleData object from a JSON object.
     * 
     * @param jsonObject The JSON object to read from
     */
    public UnsubscribeVehicleData(JSONObject jsonObject){
        super(SdlCommand.UNSUBSCRIBE_VEHICLE_DATA, jsonObject);
    ...
    /**
     * Sets a boolean value. If true, unsubscribes rpm data
     * 
     * @param rpm
     *            a boolean value
     */
	...
	public boolean equals(Object obj) {
		...
		UnsubscribeVehicleData other = (UnsubscribeVehicleData) obj;
