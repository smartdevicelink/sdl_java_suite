    ...
    public Language getLanguageDesired() {
        ...
        if (obj instanceof Language) {
            ...
            try {
            	...
            	SdlLog.e("Failed to parse " + getClass().getSimpleName() + "." + KEY_LANGUAGE_DESIRED, e);
            }
            return theCode;
        }
        return null;
    ...
    public Language getHmiDisplayLanguageDesired() {
        ...
        if (obj instanceof Language) {
            ...
            try {
            	...
            	SdlLog.e("Failed to parse " + getClass().getSimpleName() + "." + KEY_HMI_DISPLAY_LANGUAGE_DESIRED, e);
            }
            return theCode;
        }
        return null;
