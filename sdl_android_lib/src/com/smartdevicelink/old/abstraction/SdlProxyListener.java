...
import com.smartdevicelink.old.abstraction.SdlAbstraction;
...
public class SdlProxyListener implements IProxyListenerABS{
	...
	private SdlAbstraction mAbstraction;

	public SdlProxyListener(SdlAbstraction sdlAbstraction) {
		mAbstraction = sdlAbstraction;
	}
