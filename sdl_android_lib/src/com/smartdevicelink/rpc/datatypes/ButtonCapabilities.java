...
public class ButtonCapabilities extends RpcStruct {
    ...
    /**
     * Whether the button supports a SHORT press. See <i>{@linkplain com.smartdevicelink.rpc.enums.ButtonPressMode}</i> for more information.
    ...
    /**
     * Set the button supports a SHORT press. See <i>{@linkplain com.smartdevicelink.rpc.enums.ButtonPressMode}</i> for more information.
    ...
    /**
     * Whether the button supports a LONG press. See <i>{@linkplain com.smartdevicelink.rpc.enums.ButtonPressMode}</i> for more information.
     * @return True if support otherwise False.
     */
    ...
    /**
     * Set the button supports a LONG press. See <i>{@linkplain com.smartdevicelink.rpc.enums.ButtonPressMode}</i> for more information.
