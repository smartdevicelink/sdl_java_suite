...
public abstract class AbstractProtocol {
    ...
    /**
     * This method handle sdl packet from transport called from SdlConnection
     *
     * @param packet
     */
    ...
    /**
     * This method starts a protocol service
     *
     * @param sessionType
     * @param sessionID
     * @param isEncrypted
    ...
    /**
     * This method ends a protocol service
     *
     * @param serviceType
     * @param sessionID
     */
    ...
    /**
     * This method send heartbeat request packet over transport to the remote target
     *
     * @param sessionID
     */
    ...
    /**
     * This method send heartbeat ACK packet over transport to the remote target
     *
     * @param sessionID
     */
    ...
    /**
     * This method notifies listener that the out going heart beat timer should be rest
     *
     * @param sessionType
     * @param sessionID
     */
    ...
    /**
     * This method notifies listener that the incoming heart beat timer should be rest
     *
     * @param sessionType
     * @param sessionID
     */
    ...
    /**
     * This method handles the NAK of startup of a protocol session. A callback is sent
     * to the protocol listener.
     *
     * @param sessionType
     * @param sessionID
    ...
    /**
     * This method handles heart beat request. A callback is sent to the protocol listener.
     *
     * @param sessionType
     * @param sessionID
     */
    ...
    /**
     * This method handles heart beat ACK. A callback is sent to the protocol listener.
     *
     * @param sessionType
     * @param sessionID
     */
    ...
    /**
     * This method handles protocol service data ACK. A callback is sent to the protocol listener.
     *
     * @param sessionType
     * @param dataSize
     * @param sessionID
    ...
    /**
     * This method handles the incoming heart beat timer should be rest
     *
     * @param sessionType
     * @param sessionID
     */
