...
public class SdlPacket implements Parcelable {
    ...
    public byte[] toByteArray() {
        return toByteArray(version, encryption, frameType,
                serviceType, frameInfo, sessionId,
     ...
     */
    private static byte[] toByteArray(int version, boolean encryption, int frameType,
    ...
    private static int getEncryptionBit(boolean encryption) {
        if (encryption) {
    ...
    public String toString() {
        ...
        builder.append("***** Sdl Packet ******")
                ...
                .append("\nSessionId:  " + sessionId)
                .append("\nDataSize:  " + dataSize)
                .append("\nMessageId:  " + ((version > 1) ? messageId : "invalid for v1"))
                .append("\n***** Sdl Packet  End******");
